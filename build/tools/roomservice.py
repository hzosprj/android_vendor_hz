...
custom_local_manifest = ".repo/local_manifests/hz.xml"
custom_default_revision = "fourteen"
custom_default_revision =  os.getenv('ROOMSERVICE_DEFAULT_BRANCH', 'fourteen')
custom_dependencies = "hz.dependencies"
org_manifest = "HZOS-Devices"  # leave empty if org is provided in manifest
org_display = "HZOS-Devices"  # needed for displaying
